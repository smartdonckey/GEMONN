import numpy as np
from public import F_NDSort
from public import F_distance
from public import NDsort
import time

def F_EnvironmentSelect(Population,Weight_Grad_Temp,FunctionValue,N):
    ...
    Weight_Grad = Weight_Grad_Temp[Next[0, :], :]
    # Next_Population_temp = Next_Population[Next[0, :], :]
